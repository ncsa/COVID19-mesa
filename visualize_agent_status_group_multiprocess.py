...
features = ["SUSCEPTIBLE", "EXPOSED", "ASYMPTOMATIC", "SYMPDETECTED", "ASYMPDETECTED", "SEVERE", "RECOVERED",
            "DECEASED", "Vaccinated", "Generally_Infected", "Fully_Vaccinated", "Vaccine_1", "Vaccine_2"]
