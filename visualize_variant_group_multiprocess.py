...
features = ["Delta_Variant_Total_Infected", "Beta_Variant_Total_Infected", "Alpha_Variant_Total_Infected", "Xeta_Variant_Total_Infected"]
...
for file in input_filenames_list:
    ...
    out_file = out_file.replace(".csv", "-variant.png")
