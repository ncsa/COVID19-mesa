...
features = ["Susceptible", "Exposed", "Asymptomatic", "SymptQuarantined", "AsymptQuarantined", "Severe", "Recovered",
            "Deceased", "Vaccinated", "Generally_Infected", "Fully_Vaccinated", "Vaccine_1", "Vaccine_2", "Vaccine_3"]
...
for file in input_filenames_list:
    ...
    out_file = out_file.replace(".csv", "-agent_status.png")
