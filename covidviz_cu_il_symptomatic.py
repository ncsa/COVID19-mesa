...
df["0%"] = df_00["SymptQuarantined"]
df["5%"] = df_05["SymptQuarantined"]
df["10%"] = df_10["SymptQuarantined"]
df["20%"] = df_20["SymptQuarantined"]
df["40%"] = df_40["SymptQuarantined"]
df["50%"] = df_50["SymptQuarantined"]
df["75%"] = df_75["SymptQuarantined"]
df["90%"] = df_90["SymptQuarantined"]
df["all%"] = df_all["SymptQuarantined"]
...
plt.savefig("cu_il_symptomatic.png", dpi=300)
